    ...
    <div class="doc-body">
      ...
      <div class="doc-info-grid">
        <div class="doc-info-card">
          <h2 class="doc-card-label">Prepared For</h2>
        ...
        <div class="doc-info-card">
          <h2 class="doc-card-label">Details</h2>
          <div class="doc-detail-row">
            <span class="doc-detail-label">Date</span>
            <span class="doc-detail-value">{{ formatDate(data.date) }}</span>
          </div>
          <div class="doc-detail-row" v-if="data.expiry_date">
            <span class="doc-detail-label">Valid Until</span>
            <span class="doc-detail-value">{{ formatDate(data.expiry_date) }}</span>
          </div>
          <div class="doc-detail-row">
      ...
      <section v-if="data.notes" class="doc-notes-section">
        <h2 class="doc-section-heading">Notes & Terms</h2>
      ...
      <footer class="doc-footer">
        ...
        <p class="doc-footer-thanks">Thank you for choosing {{ branding.name }}</p>
...
/* ── Header Band ── */
.doc-header-band {
  background: linear-gradient(135deg, var(--doc-primary-8) 0%, var(--doc-secondary-8, var(--doc-primary-5)) 100%);
  padding: 40px 56px 36px;
  border-bottom: 1px solid var(--doc-primary-20);
}
...
.doc-company-name { font-size: 24px; font-weight: 700; color: var(--doc-primary-90, #1a1a1a); margin: 0 0 4px 0; letter-spacing: -0.01em; }
...
.doc-info-card {
  padding: 20px;
  border: 1px solid var(--doc-primary-15, #e5e7eb);
  border-radius: 12px;
  background: var(--doc-primary-5, #fafbfc);
}
...
/* ── Ornamental Divider ── */
.doc-ornamental-divider, .doc-footer-ornament {
  display: flex;
  align-items: center;
  gap: 12px;
  margin-bottom: 28px;
...
.doc-th {
  ...
  padding: 12px 8px; color: var(--doc-primary-contrast); background: var(--doc-primary);
}
...
.doc-total-grand {
  ...
  color: var(--doc-primary); padding-top: 12px; margin-top: 8px;
  border-top: 2px solid var(--doc-primary-20);
}
